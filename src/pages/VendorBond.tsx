  ...
  useEffect(() => {
    ...
    const fetch = async () => {
      try {
        ...
        if (import.meta.env.DEV) console.error("Catch fetching vendor bond:", e);
      ...
      <div className="max-w-xl mx-auto space-y-6">
        ...
        {!bond ? (
          <motion.div
            ...
            className="glass-card rounded-lg p-6 text-center neon-border"
          >
            ...
            {bond.status === "pending" && (
              <div className="glass-card rounded-lg p-6 neon-border text-center">
                ...
                <div className="inline-block p-3 bg-secondary rounded-lg mb-3">
                  <QRCodeSVG
                    value={`litecoin:${depositAddress}?amount=${bond.required_amount}`}
                    size={140}
                    bgColor="transparent"
                    fgColor="#d9d9d9"
                  />
